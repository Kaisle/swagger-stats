...
module.exports = {
    ...
    getMiddleware: function (options) {
        ...
        if (options && options.managementPort) {
          var app = require('express')();
          app.use(trackingMiddleware);
          app.listen(options.managementPort);
        }
        ...
        function trackingMiddleware(req, res, next) {
            ...
            if (!options || !options.managementPort) handleRequest(req, res);
        ...
        return options && options.managementPort ? handleRequestWrapper : trackingMiddleware;
